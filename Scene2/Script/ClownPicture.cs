...
public class ClownPicture : MonoBehaviour
{
    ...
    public Color sphereColor = Color.white; // Adjust the color as needed.
    ...
    public void PutOnWall1()
    {
        ...
        systemnaja.ClownComplete1 = true;
        PickupUI.SetActive(false);
    ...
    public void PutOnWall2()
    {
        ...
        systemnaja.ClownComplete2 = true;
        PickupUI.SetActive(false);
        PlaceUI.SetActive(false);
    ...
    public void PutOnWall3()
    {
        ...
        systemnaja.ClownComplete3 = true;
        PickupUI.SetActive(false);
        PlaceUI.SetActive(false);
