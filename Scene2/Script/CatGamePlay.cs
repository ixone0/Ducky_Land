...
public class CatGamePlay : MonoBehaviour
{
    [Header("Raycast")]
    ...
    void Start()
    {
        catpicture = gameObject.GetComponent<CatPicture>();
    ...
    void Update()
    {
        if(!catpicture.equipped && !catpicture.FinishThisPic)
        {
            RayCheck();
        }
        Phase();
...
//Reset time
        ...
        if(catpicture.InRoomDuck && dooropenclose.timeduck >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(catpicture.InRoomCat && dooropenclose.timecat >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(catpicture.InRoomClown && dooropenclose.timeclown >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(catpicture.InRoomPig && dooropenclose.timepig >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(catpicture.FinishThisPic)
        {
            TimeStartF1 = false;
            TimeStartB1 = false;
        }

        if(catpicture.equipped)
        {
            TimeStartF1 = true;
            TimeStartB1 = true;
        }
