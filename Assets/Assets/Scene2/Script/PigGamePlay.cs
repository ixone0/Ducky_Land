...
public class PigGamePlay : MonoBehaviour
{
    [Header("Raycast")]
    ...
    void Start()
    {
        pigpicture = gameObject.GetComponent<PigPicture>();
    ...
    void Update()
    {
        if(!pigpicture.equipped && !pigpicture.FinishThisPic)
        {
            RayCheck();
        }
        Phase();
...
//Reset time
        ...
        if(pigpicture.InRoomDuck && dooropenclose.timeduck >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(pigpicture.InRoomCat && dooropenclose.timecat >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(pigpicture.InRoomClown && dooropenclose.timeclown >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(pigpicture.InRoomPig && dooropenclose.timepig >= 9)
        {
            timeF1 = 0;
            timeB1 = 0;
            TimeFinishF1 = false;
        ...
        if(pigpicture.FinishThisPic)
        {
            TimeStartF1 = false;
            TimeStartB1 = false;
        }

        if(pigpicture.equipped)
        {
            TimeStartF1 = true;
            TimeStartB1 = true;
        }
